      ...
      >
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-4 w-full md:w-auto">
            <Link href="https://line.me/ti/p/5rb8ChOuei" target="_blank" className="flex-1 md:flex-none">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="https://line.me/ti/p/5rb8ChOuei" target="_blank">
                <Button
                  size="lg"
                  variant="outline"
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="https://line.me/ti/p/5rb8ChOuei" target="_blank" className="w-full sm:w-auto">
